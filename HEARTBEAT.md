...
| B-7 | iCloud egress 993 bloqueado en EC2 | AWS reauth para abrir egress SG | 🔴 ABIERTO. Creds manuelcadena@mac.com VALIDADAS local (health ok:true, inbox_count=200,855). Prod EC2 no alcanza imap.mail.me.com:993 (TCP timeout). Falta abrir egress tcp/993 en sg-0b936a3c6e57427d7 (sesión AWS expiró). iCloud → SOLO incremental (200k inbox, no full backfill) |
